...
{
    public  class LinkedinMultipleScrapRecord
    {
        ...
        #region LinkedinMultipleScrapRecord
        public LinkedinMultipleScrapRecord(string UserName, string Password, string ProxyAddress, string ProxyPort, string ProxyUserName, string ProxyPassword, string PostalCode, string Distance, string Industry, string LastName)
        {
        ...
        public void GetMultipleRecords(ref GlobusHttpHelper HttpHelper)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        Loger("[ " + DateTime.Now + " ] => [ Get RecordCount : " + RecordCount + " Using UserName : " + accountUser + " Zip Code : " + postalCode.ToString() + " Distance : " + distance + " LastName : " + lastName + " ]");
                    }

                    if (industryType != string.Empty && lastName == string.Empty)
                    {
                        Loger("[ " + DateTime.Now + " ] => [ Get RecordCount : " + RecordCount + " Using UserName : " + accountUser + " Zip Code : " + postalCode.ToString() + " Distance : " + distance + " Industry : " + industryType + " ]");
                    }

                    if (lastName == string.Empty && industryType == string.Empty)
                    {
                        Loger("[ " + DateTime.Now + " ] => [ Get RecordCount : " + RecordCount + " Using UserName : " + accountUser + " Zip Code : " + postalCode.ToString() + " Distance : " + distance + " ]");
                    }
